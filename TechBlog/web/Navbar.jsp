    ...
    <a class="navbar-brand" href="index.jsp"> <span class="fa fa-external-link-square" ></span> Tech Blog<a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="login-page.jsp"> <span class="fa fa fa-user-circle " ></span> Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="register-page.jsp"> <span class="fa fa fa-user-plus" ></span> Sign up</a>
                    </li>
